 ...
 * @author montox
 */
public class Tugas3_PilihanGandaAdaScore extends javax.swing.JFrame {

    //daftar soal dan jawaban dalam bentuk Array
    String[] NoxTanya = {
        "SOAL 1: Nama Buah Iblis Monkey D.Luffy",
        "SOAL 2: Vice Admiral Smooker tipe buah iblis nya ?",
        "SOAL 3: Julukan dari Admiral Sengkoku adalah ?",
        "SOAL 4: Nama pedang terbaru Roronoa Zorro adalah ?",
        "SOAL 5: Desa tempat tinggal Naruto namanya ?",
        "Soal 6: Naruto mempunyai iblis yang bernama ?"
    };
    String[] NoxA = {
    ...
    String[] NoxB = {"Buah Anggur", "LOGIA", "Komandan", "Pedang Laser", "Plosokandang", "Gendruwo"};
    String[] NoxC = {"Buah Apel", "Zoan", "The Budha", "Nogososro Sabuk Inten", "Tamanan", "mbak Kunthi"};
    String[] NoxD = {"Buah Bibir", "Hybrida pestisida", "Jendral", "ENMA", "Jepun", "Setan Kredit"};
    String[] NoxJWB = {"a", "b", "c", "d", "a", "a"};
     ...
     */
    public Tugas3_PilihanGandaAdaScore() {
        initComponents();
    ...
    private void NoxAboutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxAboutActionPerformed
        ...
        JOptionPane.showMessageDialog(rootPane, "Matkul Pemgorgraman JAVA Lanjut \n"
                + "PTI 4B \n"
                + "Soni Hendarkanto \n\n"
                + "Tugas 3 Membuat Program Soal Pilihan Ganda Sederhana v2 \n"
                + "Selasa 7 Maret 2023 \n\n"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tugas3_PilihanGandaAdaScore.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tugas3_PilihanGandaAdaScore().setVisible(true);
            }
        });
    }
